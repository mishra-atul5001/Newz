...
public class MainActivity extends AppCompatActivity {
    ...
    class DownloadNews extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            xmlinfo = Function.excuteGet("https://newsapi.org/v1/articles?source="
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
       ...
       if(id==R.id.notify)  {
         ...
         //  Toast.makeText(this, "Settings page in Progress..!!", Toast.LENGTH_SHORT).show();
           ...
           builder.setTitle("Newz");
           builder.setMessage("Sure about Quiting the Application..!!?");
         //  Toast.makeText(this, "Press back to stay in the App..!!", Toast.LENGTH_LONG).show();
